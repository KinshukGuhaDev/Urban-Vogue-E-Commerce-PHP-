...
$result=mysqli_query($con,"SELECT `product_id`, `product_cat`, `product_brand`, `product_title`, `product_price`, `product_desc`, `product_image`, `product_keywords`,product_mrp from products  where product_id='$product_id'") or die ("query 1 incorrect.......");

list($product_id,$product_type,$brand,$product_name,$price,$details,$pic_name,$tags,$MRP)=mysqli_fetch_array($result);
...
if($picture_type=="image/jpeg" || $picture_type=="image/jpg" || $picture_type=="image/png" || $picture_type=="image/gif")
{
	if($picture_size<=50000000)
        ...
        `product_price`='$price',`product_mrp`='$MRP',`product_desc`='$details',`product_image`='$pic_name',`product_keywords`='$tags' WHERE `product_id` = '$product_id'") or die("Query 2 is inncorrect..........");
              ...
              <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>MRP</label>
                        <input type="text" id="MRP" name="MRP" value="<?php echo $MRP ?>" required class="form-control" >
                      </div>
                    </div>
                  </div>
