					...
					<div class="col-md-12">
						...
						<div class="newsletter">
							...
							<ul class="newsletter-follow">
								<li>
									<a href="https://www.facebook.com/profile.php?id=61550583998897&mibextid=ZbWKwL"><i class="fa fa-facebook"></i></a>
								</li>
								<!-- <li>
								...
								<li>
									<a href="https://github.com/KinshukGuhaDev"><i class="fa fa-github"></i></a>
								</li>
							</ul>
						</div>
					</div>
